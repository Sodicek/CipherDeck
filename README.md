...
- kompletní české a anglické rozhraní s přepínačem `EN/CZ` a uložením volby,
- lokalizované výzvy, detekci šifry, Learn Mode, historii, nápovědu i exportní kartičky.
